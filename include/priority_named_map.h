#ifndef _priority_named_map_h
#define _priority_named_map_h

#include "string.h"

template<typename T, int items>
class Priority_named_map
{
...
public:
    ...
    bool has_priority_grater_than(int value);
    bool has_priority_grater_or_equal_than(int value);
...
template<typename T, int items>
Priority_named_map<T, items>::Priority_named_map()
:
_head(nullptr), 
_size_actual(0)
{
...
template<typename T, int items>
int Priority_named_map<T, items>::size_actual()
{
    return _size_actual;
}

template<typename T, int items>
int Priority_named_map<T, items>::size_max()
{
    return items;
}

template<typename T, int items>
bool Priority_named_map<T, items>::is_empty()
{
    return (_size_actual == 0);
}

template<typename T, int items>
bool Priority_named_map<T, items>::is_full()
{
    return (_size_actual == items);
}

template<typename T, int items>
bool Priority_named_map<T, items>::has_priority_grater_than(int value)
{
    return (at(0)->priority() > value);
}

template<typename T, int items>
bool Priority_named_map<T, items>::has_priority_grater_or_equal_than(int value)
{
    return (at(0)->priority() >= value);
}

template<typename T, int items>
bool Priority_named_map<T, items>::add(T * item)
{
...
template<typename T, int items>
T * Priority_named_map<T, items>::pop()
{
    if (_size_actual > 0)
    {
...
template<typename T, int items>
T * Priority_named_map<T, items>::remove(const char * name)
{
    auto * current = _head;
...
template<typename T, int items>
T * Priority_named_map<T, items>::peek(const char * name)
{
    auto * current = _head;
...
template<typename T, int items>
T * Priority_named_map<T, items>::at(int index)
{
...
template<typename T, int items>
T * Priority_named_map<T, items>::front()
{
    return at(0);
}

template<typename T, int items>
T * Priority_named_map<T, items>::back()
{
    return at(_size_actual);
}

template<typename T, int items>
bool Priority_named_map<T, items>::has(const char * name)
{
    auto * current = _head;
...
template<typename T, int items>
bool Priority_named_map<T, items>::_node_matches_name(Node * resident, const char * name)
{
    return (strcmp(resident->item->name(), name) == 0);
}

template<typename T, int items>
typename Priority_named_map<T, items>::Node * Priority_named_map<T, items>::_node_find(const char * name)
{
    auto * current = _head;
...
template<typename T, int items>
void Priority_named_map<T, items>::_node_attach_after(Node * resident, Node * candidate)
{
...
template<typename T, int items>
void Priority_named_map<T, items>::_node_attach_before(Node * resident, Node * candidate)
{
...
template<typename T, int items>
void Priority_named_map<T, items>::_node_deattach(Node * node)
{
    node->is_empty = true;
